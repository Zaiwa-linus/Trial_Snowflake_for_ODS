...
使い方:
  uv run python scripts/search_stats.py "人口"
  uv run python scripts/search_stats.py "GDP" --field 07        # 統計分野で絞り込み
  uv run python scripts/search_stats.py "労働" --limit 20       # 取得件数指定
  uv run python scripts/search_stats.py --list-fields            # 統計分野コード一覧を表示
"""
...
使用例:
  uv run python scripts/search_stats.py "人口"
  uv run python scripts/search_stats.py "GDP" --field 07
  uv run python scripts/search_stats.py "労働力" --years 2023
  uv run python scripts/search_stats.py --list-fields
        """,
    )
